...
* `/fundamentals` - Basic syntax, data types, and control flow.
* `/oop-and-functional` - Object-Oriented and Functional programming concepts.
* `/async-js` - Fetch API, Promises, and handling data.
* `/mini-projects` - Small, hands-on applications.
